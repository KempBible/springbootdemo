package com.example.springbootdemo.rocketmq.config;
...
public class MyTransactionImpl implements RocketMQLocalTransactionListener {
    ...
    public RocketMQLocalTransactionState executeLocalTransaction(Message msg, Object arg) {
        ...
        org.apache.rocketmq.common.message.Message message = RocketMQUtil
                .convertToRocketMessage(new StringMessageConverter(), "UTF-8", destination, msg);
