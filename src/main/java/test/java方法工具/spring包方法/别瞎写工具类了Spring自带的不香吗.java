...
//        isAssignable(String.class, Integer.class, "你不是我的子类");
        ...
        // 从字节数组到文件
        File outFile1 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Thread共享变量的使用.java");
        FileCopyUtils.copy(FileCopyUtils.copyToByteArray(file), outFile1);

        // 从文件到文件
        File outFile2 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test2.java");
        FileCopyUtils.copy(file, outFile2);

        // 从字节数组到输出流
        File outFile3 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test3.java");
        ...
        File outFile4 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test4.java");
        ...
        File outFile5 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test5.java");
        ...
        File outFile6 = new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test6.java");
        ...
        // 文件系统资源 D:\...
        Resource resource1 = new FileSystemResource(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java"));
        // 判断资源是否存在
...
//        Resource resource4 = new ServletContextResource(null, "resources/application.properties");
        ...
        //定义指定磁盘的文件的File对象
        FileReader fr = new FileReader(ResourceUtils.getFile(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java"));
        char[] data = new char[23];            //定义char数组
        int length = 0;

        FileOutputStream output = new FileOutputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/text.java"));
        String result = null;
        ...
        // 你猜默认编码是什么
        StreamUtils.copy(("测试下").getBytes(), new FileOutputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test7.java")));

        int result8 = StreamUtils.copy(new FileInputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java")),
                new FileOutputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test8.java")));
        System.out.println(result8);

        // 试试gbk，看看是不是一样
        StreamUtils.copy("哇哇", Charset.forName("UTF-8"), new FileOutputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test9.java")));

        long result10 = StreamUtils.copyRange(new FileInputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java")),
                new FileOutputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/Test10.java")), 0, 100);
        System.out.println(result10);

        System.out.println("------StreamUtils-输出------");
        System.out.println(Arrays.toString(StreamUtils.copyToByteArray(new FileInputStream(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java"))));

        // 试试utf-8
        System.out.println(StreamUtils.copyToString(new FileInputStream(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java"), Charset.forName("gbk")));

        // 舍弃输入流中的内容
        System.out.println(StreamUtils.drain(new FileInputStream(new File(System.getProperty("user.dir") + "/src/main/java/test/java方法工具/spring包方法/别瞎写工具类了Spring自带的不香吗.java"))));
