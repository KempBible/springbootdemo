 ...
 *      6.1可重复注解：a.在MyAnnotation上声明@Repeatable，成员值为MyAnnotations.class
 *                   b.MyAnnotation的Target和Retention和MyAnnotations相同
 *      6.2类型注释：
 *      ElementType.TYPE_PARAMETER 表示该注释能写在类型变量的声明语句中（如：范型声明）
 *      ElementType.TYPE_USE 表示该注解能写在使用类型的任何语句中
 *
 */
public class jdk8新特性可重复注解 {
...
// 注解的可重复性
// jdk 8之前的方法：
// @MyAnnotations({@MyAnnotation3(value = "hi"), @MyAnnotation3(value = "abc")})
@MyAnnotation3(value = "hi")
...
class Student3 extends Person3 implements Info3{
