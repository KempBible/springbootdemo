 ...
 *      6.1可重复注解：
 */
public class jdk中4个基本的元注解的使用2_2 {

    // 反射
    @Test
    public void testGetAnnotation(){
        Class clazz = Student2_2.class;
...
class Person2_2{
    ...
    @MyAnnotation2_2
    public Person2_2(String name, int age) {
        this.name = name;
        this.age = age;
    }
...
class Student2_2 extends Person2_2 implements Info2_2{
