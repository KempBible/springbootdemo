 ...
 *
 *    5.通过反射获取注解信息 -->到反射内容时系统
 */
public class jdk中4个基本的元注解的使用2_1 {

    // 反射
    @Test
    public void testGetAnnotation(){
        Class clazz = Student2_1.class;
        Annotation[] annotations = clazz.getAnnotations();
        for (int i = 0; i < annotations.length; i++) {
            System.out.println(annotations[i]);
        }
        // @test.尚学谷.bilibili_5_枚举与注解.Annotation.MyAnnotation2(value=hi)
    }
...
class Student2_1 extends Person2_1 implements Info2_1{
